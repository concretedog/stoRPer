...
'''
This script is a simple example that drives all motors forward continuously. Commented out in the lower section you can see examples of reversing and turning.  
